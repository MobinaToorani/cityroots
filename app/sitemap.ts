...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE}/kitchener`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    { url: `${BASE}/waterloo`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    { url: `${BASE}/cambridge`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
